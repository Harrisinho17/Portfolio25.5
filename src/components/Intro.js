      ...
      <div className="intro-content">
        <div className="typist-content">
          <div className="text-typing-container" style={{ position: "relative" }}>
            ...
            <span className="intro-name" ref={nameRef}>Alex.</span>
            <div 
              ref={cursorRef} 
        ...
        <div className="intro-subtitle" ref={subtitleRef}>
          An <span className="intro-subtitle-name">Implementation Analyst</span> with a love for data.  
        </div>
        
        <div className="intro-desc" ref={descRef}>
          I'm an inquisitive individual with a passion for using tecknology to solve real-world problems. I enjoy the process of being a detective, piecing together clues to find solutions. 
        </div>
