...
export default function SideNavBar({ showStars, setShowStars }) {
  ...
  return (
    <div className="side-navbar" ref={sideNavRef}>
      <a href="https://github.com/Harrisinho17" title="GitHub" target="_blank" rel="noopener noreferrer" ref={addToRefs}>
        <Icon name="GitHub" className="sidenav-icon"/>
      </a>
      <a href="https://www.linkedin.com/in/alexanderbharris-9906/" title="LinkedIn" target="_blank" rel="noopener noreferrer" ref={addToRefs}>
        <Icon name="Linkedin" className="sidenav-icon"/>
      </a>
      <a href="https://www.kaggle.com/alexbharr" title="Kaggle" target="_blank" rel="noopener noreferrer" ref={addToRefs}>
        <Icon name="Kaggle" className="sidenav-icon"/>
      </a>
